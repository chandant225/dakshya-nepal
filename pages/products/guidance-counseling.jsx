  ...
  return (
    <>
      <NextSeo
        ...
        description="Dakshya Nepal brings to you Guidance Counselors who help both the parents and students to resolve their respective issues. We are trying to incorporate wider goals of helping students develop socially, personally and academically. We are also trying to be the mediator for parents to help them find a better way to interact with their children academically and personally."
        canonical="https://dakshyanepal.com/products/guidance-counseling"
        openGraph={{
          type: "website",
          locale: "en_IE",
          site_name: "Dakshya Nepal",
          url: "https://dakshyanepal.com/products/guidance-counseling",
          title: "Guidance Counseling",
          description:
            "Dakshya Nepal brings to you Guidance Counselors who help both the parents and students to resolve their respective issues. We are trying to incorporate wider goals of helping students develop socially, personally and academically. We are also trying to be the mediator for parents to help them find a better way to interact with their children academically and personally.",
          images: [
            {
              url:
                "https://dakshyanepal.com/illustrations/Guidance%20Counseling.svg",
              width: 100,
              height: 100,
      ...
      <div className="container mx-auto">
        ...
        <div className="lg:mt-0 mt-8">
          ...
          <p className="text-gray-500">
            ...
            parents and students to resolve their respective issues. We are
            trying to incorporate wider goals of helping students develop
            socially, personally and academically. We are also trying to be the
            mediator for parents to help them find a better way to interact with
            their children academically and personally.
          </p>
        </div>
        <div className="">
          <div className="flex lg:flex-row flex-col-reverse lg:gap-12 gap-4 items-center justify-center lg:py-10">
            <div data-aos="fade-up-right" className="lg:w-[60%] w-full">
              ...
              <p className="text-gray-500">
                Students go through plenty of hardships in studies,
                relationships with friends and family, social life or the
                outside world which needs to be addressed in a proper time.
                Guidance counselors are here to help them tackle such hurdles
                they face.
              </p>
            </div>
            <div
          ...
          <div className="flex lg:flex-row flex-col lg:gap-12 gap-4 items-center justify-center lg:py-10">
            ...
            <div data-aos="flip-right" className="lg:w-[60%] w-full">
              ...
              <p className="text-gray-500">
                Kids are not comfortable sharing their problems with their
                parents fearing they might not understand while parents find it
                difficult to get through their children in most situations.
                Guidance counselors will help both of them tie up the loose ends
              </p>
            </div>
          </div>
          <div className="flex lg:flex-row flex-col-reverse lg:gap-12 gap-4 items-center justify-center lg:py-10">
            <div data-aos="slide-up" className="lg:w-[60%] w-full">
              ...
              <p className="text-gray-500">
                ...
                achieve their respective goals to develop socially, personally
                and academically. This will always be kept confidential
              </p>
            </div>
            <div className="bg-[#FEF6E0] lg:w-[40%] lg:mt-0 mt-6">
              <img
          ...
          <div className="flex lg:flex-row flex-col gap-8 mt-2">
            ...
            <div data-aos="zoom-in" className="lg:w-[50%] w-full">
              ...
              <p className="text-gray-500 mt-4">
                ...
                selection Early intervention about learning difficulties
                Maintain academic standards Develop skills to improve
                organization, time management and study habits Identify
                interests, strengths and aptitudes through assessment Any other
                aspect on which guidance is needed
              </p>
            </div>
          </div>
        </div>
