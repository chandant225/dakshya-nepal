...
{loading ? (
  ...
  {DisplayBlogs && DisplayBlogs.map((blog,index) => (
...
<button onClick={() => {
  loadmore();
}} className="border-4 border-blue-700 rounded-md py-2 px-4 focus:outline-none text-xl text-blue-700 font-bold">Load More Blogs</button>
</center>
</div>
)}
</>
