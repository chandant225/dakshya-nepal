  ...
  return (
    <div className=" bg-white">
      <Transition appear show={true} as={Fragment}>
        <Dialog
          as="div"
          className="fixed inset-0 z-40yyyyyyyyy overflow-y-auto"
          onClose={() => setApplyBook(false)}
        >
                  ...
                  <RemoveScroll className="">
                    <div className="">
                      <div className="flex">
                          ...
                          <div className=" flex justify-between pt-3 md:pt-0">
                            ...
                            {mobile ? (
                              <button
                                ...
                                onClick={() => setApplyBookBook(false)}
                              >
                                <img
                                  src="/icons/Exit.svg"
                        ...
                        {success && (
                          <Notification
                            message="Booking Success. We will contact you ASAP"
